...
} from './components/example/translations-select-placeholder-usage/translations-select-placeholder-usage.component';
export {
  TranslationsSelectedItemWrapPlaceholderUsageComponent
} from './components/example/translations-selected-item-wrap-placeholder-usage/translations-selected-item-wrap-placeholder-usage.component';
