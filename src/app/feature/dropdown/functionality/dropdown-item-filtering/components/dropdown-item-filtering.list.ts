...
export const itemFilteringUsage: ExampleFile[] = [
  {
    ...
    content: require('!!raw-loader!./example/item-filtering-usage/item-filtering-usage.component.ts')
  },
  {
    type: FileType.HTML,
    name: 'item-filtering-usage.component.html',
    content: require('!!raw-loader!./example/item-filtering-usage/item-filtering-usage.component.html')
  },
  {
    type: FileType.TS,
    name: 'item-filtering-usage.module.ts',
    content: require('!!raw-loader!./example/item-filtering-usage/item-filtering-usage.module.md')
  },
];
...
export const itemFilteringServerSideUsage: ExampleFile[] = [
  {
    ...
    content: require('!!raw-loader!./example/item-filtering-server-side/item-filtering-server-side.component.ts')
  },
  {
    type: FileType.HTML,
    name: 'item-filtering-server-side.component.html',
    content: require('!!raw-loader!./example/item-filtering-server-side/item-filtering-server-side.component.html')
  }
];
