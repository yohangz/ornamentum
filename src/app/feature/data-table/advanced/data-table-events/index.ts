export { DataTableEventsComponent } from './components/data-table-events.component';
...
export { EventsHeaderClickUsageComponent } from './components/example/events-header-click-usage/events-header-click-usage.component';
