...
export const serverSideWebSocketUsage: ExampleFile[] = [
  {
    ...
    content: require(
      '!!raw-loader?lang=typescript!./example/server-side-web-socket-usage/server-side-web-socket-usage.module.md')
  },
  {
    type: FileType.TS,
    name: 'server-side-web-socket-usage.component.ts',
    content: require(
      '!!raw-loader?lang=typescript!./example/server-side-web-socket-usage/server-side-web-socket-usage.component.ts')
  },
  {
    type: FileType.HTML,
