...
export const responsiveConfUsage: ExampleFile[] = [
  {
    ...
    content: require('!!raw-loader?lang=typescript!./example/responsive-conf-usage/responsive-conf-usage.module.md')
  },
  {
    type: FileType.TS,
    name: 'responsive-conf-usage.component.ts',
    content: require('!!raw-loader?lang=typescript!./example/responsive-conf-usage/responsive-conf-usage.component.ts')
  },
  {
    type: FileType.HTML,
    name: 'responsive-conf-usage.component.html',
    content: require('!!raw-loader?lang=html!./example/responsive-conf-usage/responsive-conf-usage.component.html')
  }
];
