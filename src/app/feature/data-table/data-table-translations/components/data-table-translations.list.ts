...
export const dataTableTranslationsPaginationUsage: ExampleFile[] = [
  {
    ...
    content: require('!!raw-loader?lang=typescript!./example/data-table-translations-pagination-usage/data-table-translations-pagination-usage.module.md')
  },
  {
    type: FileType.TS,
    name: 'data-table-translations-pagination-usage.component.ts',
    content: require('!!raw-loader?lang=typescript!./example/data-table-translations-pagination-usage/data-table-translations-pagination-usage.component.ts')
  },
  {
    type: FileType.HTML,
